---
name: brainstorming
description: Explores user intent, requirements, and design before implementation. Use when starting new features, tasks, or creative work.
---

# Brainstorming Ideas Into Designs

## When to use this skill
- Before any creative work (creating features, building components, modifying behavior)
...
digraph brainstorming {
    ...
    "Write design doc" -> "Invoke planning skill";
}
```
