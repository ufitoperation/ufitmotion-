...
def send_invite_email(to: str, first_name: str, role: str, token: str) -> bool:
    ...
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111;">
      ...
      <div style="border:1px solid #e5e7eb;border-top:none;padding:32px;border-radius:0 0 8px 8px;">
        <h2 style="margin:0 0 8px;">Welcome, {first_name}!</h2>
        ...
        <p style="margin:24px 0 0;font-size:13px;color:#9ca3af;">This link expires in 1 hour. If you didn't expect this email, you can safely ignore it.</p>
...
def send_password_reset_email(to: str, first_name: str, token: str) -> bool:
    ...
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111;">
      ...
      <div style="border:1px solid #e5e7eb;border-top:none;padding:32px;border-radius:0 0 8px 8px;">
        ...
        <p style="color:#6b7280;margin:0 0 24px;">Hi {first_name}, we received a request to reset your Ufit Motion password.</p>
